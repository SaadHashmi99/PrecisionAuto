            ...
            <View style={{margin: 10, marginTop: 30}}>
              <Grid>
                <Col size={25}>
                  ...
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#bfa09d'}]}>
                ...
                <Col size={20}>
                  <Row style={[STYLES.RowView, {height: 60, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#ffffff', fontSize: 16}]}>DEAL PRICE</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#ffffff'}]}>
                    <Dropdown
                ...
                <Col size={17}>
                  <Row style={[STYLES.RowView, {height: 60, backgroundColor: colors.SECONDARY}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', color: '#ffffff', fontSize: 16}]}>DAYS</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#ffffff'}]}>
                    <Dropdown
                ...
                <Col size={25}>
                  ...
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#bfa09d', flexDirection: 'column'}]}>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, color: '#ffffff', marginTop: 16}]}>GENERATE PO</Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
