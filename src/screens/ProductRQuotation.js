              ...
              <Grid>
                ...
                <Col size={20}>
                  <Row style={[STYLES.RowView, {height: 60, backgroundColor: '#36c3d0'}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', fontSize: 16}]}>DEAL PRICE</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#ffffff'}]}>
                    <Dropdown
                ...
                <Col size={17}>
                  <Row style={[STYLES.RowView, {height: 60, backgroundColor: '#36c3d0'}]}>
                    <Text style={[STYLES.RowText, {fontWeight: 'bold', fontSize: 16}]}>DAYS</Text>
                  </Row>
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#ffffff'}]}>
                    <Dropdown
                ...
                <Col size={25}>
                  ...
                  <Row style={[STYLES.RowView, {height: 70, backgroundColor: '#ffffff', flexDirection: 'column'}]}>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, marginTop: 16}]}>GENERATE PO</Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
                      <Text style={[STYLES.appButtonUsers, {alignSelf: 'center', fontSize: 8, marginTop: 5}]}> REJECT QUOTATION</Text>
                    </TouchableOpacity>
                  </Row>
